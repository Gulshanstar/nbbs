        ...
        if isinstance(value, dict):
            ...
            for i, v in enumerate(value):
                if isinstance(v, dict):
                    items.update(flatten_json(v, f"{new_key}_{i}", sep=sep))
                else:
...
if __name__ == "__main__":
    csv_file = r'/home/gulshan/Desktop/NBS/Book.csv'
    json_folder = r'/home/gulshan/Desktop/NBS/apna/'  # Provide the path to your JSON folder
